...
def download_file(version=None):
    ...
    print(f"Downloading Titli Dashboard version: {version}")
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Update script for Titli Dashboard.')
    parser.add_argument('-c', '--check', action='store_true', help='Check the current version of the Titli Dashboard')
    parser.add_argument('-v', '--version', type=str, help='Install the specified version of the Titli Dashboard')
    parser.add_argument('-l', '--latest', action='store_true', help='Install the latest version of the Titli Dashboard from Github')
    parser.add_argument('-b', '--beta', action='store_true', help='Install the beta version of the Titli Dashboard from Github')
