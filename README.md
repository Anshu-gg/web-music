...
# Titli Dashboard
Titli Dashboard is a web-based user interface that allows users to control the [Titli music bot](https://github.com/Anshu-gg/Titli) directly from their browser. With this dashboard, you can easily manage music playback, create playlists, and interact with the bot in a user-friendly way.
